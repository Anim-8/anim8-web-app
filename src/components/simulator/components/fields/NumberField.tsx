    ...
    return (
        <div className={className}>
            <div className="flex items-center gap-1">
                ...
                {tooltip && (
                    <Tooltip content={tooltip} side="top" size="lg" contentClassName="w-[28rem] max-w-none leading-6" >
                        <HelpCircle className="mb-1 h-5 w-5 text-cyan-300 hover:text-cyan-200 drop-shadow-[0_0_6px_rgba(34,211,238,0.55)]" />
                    </Tooltip>
                )}
            </div>
            ...
            />
            {helpText && <p className="mt-1 text-[14px] text-gray-400">{helpText}</p>}
        </div>
    );
}
