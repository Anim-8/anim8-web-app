...
const ServiceHeroText: React.FC = () => {
  return (
    <div className="text-left">
      ...
      <div className="flex gap-4">
        <button className="bg-primary text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-primary/80 transition">
          Start with a Diagnostic
        </button>
        <button className="border border-white/20 text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/10 transition">
